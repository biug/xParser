...
template<class RET_TYPE> using SuperTagSet2Map = PackedScoreMap<TwoInts, ScoreArray<RET_TYPE>, RET_TYPE, AddScoreType>;
...
template<class RET_TYPE> using WordSuperTagMap = PackedScoreMap<TwoInts, ScoreArray<RET_TYPE>, RET_TYPE, AddScoreType>;
template<class RET_TYPE> using POSTagSuperTagMap = PackedScoreMap<TwoInts, ScoreArray<RET_TYPE>, RET_TYPE, AddScoreType>;
template<class RET_TYPE> using WordPOSTagSuperTagMap = PackedScoreMap<ThreeInts, ScoreArray<RET_TYPE>, RET_TYPE, AddScoreType>;
