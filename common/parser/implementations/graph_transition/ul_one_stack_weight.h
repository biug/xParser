#ifndef _UL_ONE_STACK_WEIGHT_H
#define _UL_ONE_STACK_WEIGHT_H
...
namespace graph_transition {
	...
	class ULOneStackWeight : public GraphWeightBase {
	public:
		...
		// st + n0 + st left/right head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTwN0ptSTLHptSTLHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0wSTLHptSTLHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0ptSTLHwSTLHl;
		POSTagSet3Map<RET_TYPE> m_mapSTptN0ptSTLHptSTLHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTwN0ptSTLPptSTLPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0wSTLPptSTLPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0ptSTLPwSTLPl;
		POSTagSet3Map<RET_TYPE> m_mapSTptN0ptSTLPptSTLPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTwN0ptSTRHptSTRHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0wSTRHptSTRHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0ptSTRHwSTRHl;
		POSTagSet3Map<RET_TYPE> m_mapSTptN0ptSTRHptSTRHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTwN0ptSTRPptSTRPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0wSTRPptSTRPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0ptSTRPwSTRPl;
		POSTagSet3Map<RET_TYPE> m_mapSTptN0ptSTRPptSTRPl;

		// st + n0 + n0 left head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTwN0ptN0LHptN0LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0wN0LHptN0LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0ptN0LHwN0LHl;
		POSTagSet3Map<RET_TYPE> m_mapSTptN0ptN0LHptN0LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTwN0ptN0LPptN0LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0wN0LPptN0LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSTptN0ptN0LPwN0LPl;
		POSTagSet3Map<RET_TYPE> m_mapSTptN0ptN0LPptN0LPl;

		// quar-gram
		// st + n0 + st right head + st right pred
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptSTRHptSTRPptSTRHlSTRPl;
		// st + n0 + st left pred + st left pred 2
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptSTLPptSTLP2ptSTLPlSTLP2l;
		// st + n0 + st right pred + st right pred 2
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptSTRPptSTRP2ptSTRPlSTRP2l;
		// st + n0 + n0 left head + n0 left pred
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptN0LHptN0LPptN0LHlN0LPl;
		// st + n0 + n0 left pred + n0 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptN0LPptN0LP2ptN0LPlN0LP2l;

		// st2 + n0 + st2 left/right head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2LHptST2LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2LHptST2LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2LHwST2LHl;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2LHptST2LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2LPptST2LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2LPptST2LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2LPwST2LPl;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2LPptST2LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2RHptST2RHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2RHptST2RHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2RHwST2RHl;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2RHptST2RHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2RPptST2RPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2RPptST2RPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2RPwST2RPl;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2RPptST2RPl;

		// st + n0 + n0 left head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptN0LHptN0LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wN0LHptN0LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptN0LHwN0LHl;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptN0LHptN0LHl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptN0LPptN0LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wN0LPptN0LPl;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptN0LPwN0LPl;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptN0LPptN0LPl;

		// quar-gram
		// st2 + n0 + st2 right head + st2 right pred
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptST2RHptST2RPptST2RHlST2RPl;
		// st2 + n0 + st2 left pred + st2 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptST2LPptST2LP2ptST2LPlST2LP2l;
		// st2 + n0 + st2 right pred + st2 right pred 2
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptST2RPptST2RP2ptST2RPlST2RP2l;
		// st2 + n0 + n0 left head + n0 left pred
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptN0LHptN0LPptN0LHlN0LPl;
		// st2 + n0 + n0 left pred + n0 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptN0LPptN0LP2ptN0LPlN0LP2l;
	...
	public:
		ULOneStackWeight(const std::string & sRead, const std::string & sRecord,
				DWord * pWords, DPOSTag * pPOSTags);
		~ULOneStackWeight();
	...
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE> WordPOSTag ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::empty_taggedword = WordPOSTag();
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE> WordPOSTag ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::start_taggedword = WordPOSTag();
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE> WordPOSTag ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::end_taggedword = WordPOSTag();
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE> TagSet ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::empty_tagset = TagSet();

	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE>
	ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::ULOneStackWeight(const std::string & sRead, const std::string & sRecord,
			DWord * pWords, DPOSTag * pPOSTags) :
		GraphWeightBase(sRead, sRecord, pWords, pPOSTags, nullptr, nullptr, nullptr, nullptr),
		// uni-gram
		// st, n0, st2
		m_mapSTw("m_mapSTw"),
		m_mapSTpt("m_mapSTpt"),
	...
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE>
	ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::~ULOneStackWeight() = default;

	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE>
	void ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::loadScores() {
	...
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE>
	void ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::saveScores() const {
	...
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE>
	void ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::computeAverageFeatureWeights(const int & round) {
	...
	template<class RET_TYPE, class STATE_TYPE, class ACTION_TYPE>
	void ULOneStackWeight<RET_TYPE, STATE_TYPE, ACTION_TYPE>::getOrUpdateFeatureScores(GraphDepParserBase<RET_TYPE, STATE_TYPE, ACTION_TYPE> * parser, const STATE_TYPE & item, const ActionScoreIncrement & amount) {
		int dis = -1;
		...
		// st + n0 + st left/right head/pred
		bi_features.refer(st_word, ENCODE_POSTAG_SET_2(stlh_postag, n0_postag));
		m_mapSTwN0ptSTLHptSTLHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st_postag, stlh_postag));
		m_mapSTptN0wSTLHptSTLHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(stlh_word, ENCODE_POSTAG_SET_2(st_postag, n0_postag));
		m_mapSTptN0ptSTLHwSTLHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st_postag, stlh_postag, n0_postag);
		m_mapSTptN0ptSTLHptSTLHl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st_word, ENCODE_POSTAG_SET_2(stlp_postag, n0_postag));
		m_mapSTwN0ptSTLPptSTLPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st_postag, stlp_postag));
		m_mapSTptN0wSTLPptSTLPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(stlp_word, ENCODE_POSTAG_SET_2(st_postag, n0_postag));
		m_mapSTptN0ptSTLPwSTLPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st_postag, stlp_postag, n0_postag);
		m_mapSTptN0ptSTLPptSTLPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st_word, ENCODE_POSTAG_SET_2(strh_postag, n0_postag));
		m_mapSTwN0ptSTRHptSTRHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st_postag, strh_postag));
		m_mapSTptN0wSTRHptSTRHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(strh_word, ENCODE_POSTAG_SET_2(st_postag, n0_postag));
		m_mapSTptN0ptSTRHwSTRHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st_postag, strh_postag, n0_postag);
		m_mapSTptN0ptSTRHptSTRHl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st_word, ENCODE_POSTAG_SET_2(strp_postag, n0_postag));
		m_mapSTwN0ptSTRPptSTRPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st_postag, strp_postag));
		m_mapSTptN0wSTRPptSTRPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(strp_word, ENCODE_POSTAG_SET_2(st_postag, n0_postag));
		m_mapSTptN0ptSTRPwSTRPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st_postag, strp_postag, n0_postag);
		m_mapSTptN0ptSTRPptSTRPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);

		// st + n0 + n0 left head/pred
		bi_features.refer(st_word, ENCODE_POSTAG_SET_2(n0_postag, n0lh_postag));
		m_mapSTwN0ptN0LHptN0LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st_postag, n0lh_postag));
		m_mapSTptN0wN0LHptN0LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0lh_word, ENCODE_POSTAG_SET_2(st_postag, n0_postag));
		m_mapSTptN0ptN0LHwN0LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st_postag, n0_postag, n0lh_postag);
		m_mapSTptN0ptN0LHptN0LHl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st_word, ENCODE_POSTAG_SET_2(n0_postag, n0lp_postag));
		m_mapSTwN0ptN0LPptN0LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st_postag, n0lp_postag));
		m_mapSTptN0wN0LPptN0LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0lp_word, ENCODE_POSTAG_SET_2(st_postag, n0_postag));
		m_mapSTptN0ptN0LPwN0LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st_postag, n0_postag, n0lp_postag);
		m_mapSTptN0ptN0LPptN0LPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);

		// quar-gram
		// st + n0 + st right head + st right pred
		poses_feature = encodePOSTagSet4(st_postag, strh_postag, strp_postag, n0_postag);
		m_mapSTptN0ptSTRHptSTRPptSTRHlSTRPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st + n0 + st left pred + st left pred 2
		poses_feature = encodePOSTagSet4(st_postag, stlp_postag, stlp2_postag, n0_postag);
		m_mapSTptN0ptSTLPptSTLP2ptSTLPlSTLP2l.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st + n0 + st right pred + st right pred 2
		poses_feature = encodePOSTagSet4(st_postag, strp_postag, strp2_postag, n0_postag);
		m_mapSTptN0ptSTRPptSTRP2ptSTRPlSTRP2l.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st + n0 + n0 left head + n0 left pred
		poses_feature = encodePOSTagSet4(st_postag, n0_postag, n0lh_postag, n0lp_postag);
		m_mapSTptN0ptN0LHptN0LPptN0LHlN0LPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st + n0 + n0 left pred + n0 left pred 2
		poses_feature = encodePOSTagSet4(st_postag, n0_postag, n0lp_postag, n0lp2_postag);
		m_mapSTptN0ptN0LPptN0LP2ptN0LPlN0LP2l.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);

		// st2 + n0 + st2 left/right head/pred
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2lh_postag, n0_postag));
		m_mapST2wN0ptST2LHptST2LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2lh_postag));
		m_mapST2ptN0wST2LHptST2LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(st2lh_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		m_mapST2ptN0ptST2LHwST2LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2lh_postag, n0_postag);
		m_mapST2ptN0ptST2LHptST2LHl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2lp_postag, n0_postag));
		m_mapST2wN0ptST2LPptST2LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2lp_postag));
		m_mapST2ptN0wST2LPptST2LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(st2lp_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		m_mapST2ptN0ptST2LPwST2LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2lp_postag, n0_postag);
		m_mapST2ptN0ptST2LPptST2LPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2rh_postag, n0_postag));
		m_mapST2wN0ptST2RHptST2RHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2rh_postag));
		m_mapST2ptN0wST2RHptST2RHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(st2rh_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		m_mapST2ptN0ptST2RHwST2RHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2rh_postag, n0_postag);
		m_mapST2ptN0ptST2RHptST2RHl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2rp_postag, n0_postag));
		m_mapST2wN0ptST2RPptST2RPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2rp_postag));
		m_mapST2ptN0wST2RPptST2RPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(st2rp_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		m_mapST2ptN0ptST2RPwST2RPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2rp_postag, n0_postag);
		m_mapST2ptN0ptST2RPptST2RPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);

		// st2 + n0 + n0 left head/pred
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(n0_postag, n0lh_postag));
		m_mapST2wN0ptN0LHptN0LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, n0lh_postag));
		m_mapST2ptN0wN0LHptN0LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0lh_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		m_mapST2ptN0ptN0LHwN0LHl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, n0_postag, n0lh_postag);
		m_mapST2ptN0ptN0LHptN0LHl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(n0_postag, n0lp_postag));
		m_mapST2wN0ptN0LPptN0LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, n0lp_postag));
		m_mapST2ptN0wN0LPptN0LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		bi_features.refer(n0lp_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		m_mapST2ptN0ptN0LPwN0LPl.getOrUpdateScore(packedScore, bi_features, scoreIndex, amount, trainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, n0_postag, n0lp_postag);
		m_mapST2ptN0ptN0LPptN0LPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);

		// quar-gram
		// st2 + n0 + st2 right head + st2 right pred
		poses_feature = encodePOSTagSet4(st2_postag, st2rh_postag, st2rp_postag, n0_postag);
		m_mapST2ptN0ptST2RHptST2RPptST2RHlST2RPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st2 + n0 + st2 left pred + st2 left pred 2
		poses_feature = encodePOSTagSet4(st2_postag, st2lp_postag, st2lp2_postag, n0_postag);
		m_mapST2ptN0ptST2LPptST2LP2ptST2LPlST2LP2l.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st2 + n0 + st2 right pred + st2 right pred 2
		poses_feature = encodePOSTagSet4(st2_postag, st2rp_postag, st2rp2_postag, n0_postag);
		m_mapST2ptN0ptST2RPptST2RP2ptST2RPlST2RP2l.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st2 + n0 + n0 left head + n0 left pred
		poses_feature = encodePOSTagSet4(st2_postag, n0_postag, n0lh_postag, n0lp_postag);
		m_mapST2ptN0ptN0LHptN0LPptN0LHlN0LPl.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
		// st2 + n0 + n0 left pred + n0 left pred 2
		poses_feature = encodePOSTagSet4(st2_postag, n0_postag, n0lp_postag, n0lp2_postag);
		m_mapST2ptN0ptN0LPptN0LP2ptN0LPlN0LP2l.getOrUpdateScore(packedScore, poses_feature, scoreIndex, amount, trainingRound);
