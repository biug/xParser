#ifndef _TWO_WAY_SHIFT_REDUCE_DEPPARSER_H
#define _TWO_WAY_SHIFT_REDUCE_DEPPARSER_H

#include <vector>
#include <unordered_set>

#include "two_way_shift_reduce_state.h"
#include "two_way_shift_reduce_weight.h"
#include "common/parser/implementations/graph_transition_two_way/graph_transition_two_way_depparser_base.h"

namespace two_way_shift_reduce {

	using graph_transition_two_way::GraphDepParserBase;
