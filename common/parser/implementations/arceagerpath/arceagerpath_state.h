#ifndef _ARCEAGERPATH_STATE_H
#define _ARCEAGERPATH_STATE_H
...
namespace arceagerpath {
	...
	public:
		...
		void generateTree(const DependencyPathTree & sent, DependencyTree & tree) const;
		bool standardMove(const DependencyPathTree & tree);
