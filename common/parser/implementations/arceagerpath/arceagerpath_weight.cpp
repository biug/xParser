...
namespace arceagerpath {
	Weight::Weight(const std::string & sRead, const std::string & sRecord) :
		...
		m_mapSTPOSPath("Stack2NextWordPOSPath"),
		m_mapSTFPOSPath("Stack2NextFirstPOSPath"),
		m_mapSTwN0ptSTsynhw("StackWordNextTagStackTreeHeadWord"),
		m_mapSTwN0wSTsynhpt("StackWordNextWordStackTreeHeadTag"),
		m_mapSTptN0wSTsynhw("StackTagNextWordStackTreeHeadWord"),
		m_mapSTwN0ptN0synhw("StackWordNextTagNextTreeHeadWord"),
		m_mapSTwN0wN0synhpt("StackWordNextWordNextTreeHeadTag"),
		m_mapSTptN0wN0synhw("StackTagNextWordNextTreeHeadWord")
	{
		loadScores();
