...
namespace nivre {
	...
	public:
		...
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptSTRHptSTRPpt;
		// st + n0 + st left pred + st left pred 2
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptSTLPptSTLP2pt;
		// st + n0 + st right pred + st right pred 2
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptSTRPptSTRP2pt;
		// st + n0 + n0 left pred + n0 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapSTptN0ptN0LPptN0LP2pt;

		// st2 + n0 + st2 left/right head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2LHw;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2LPw;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2RHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2RHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2RHw;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2RHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptST2RPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wST2RPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptST2RPw;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptST2RPpt;

		// st2 + n0 + n0 left head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptN0LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wN0LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptN0LHw;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptN0LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2wN0ptN0LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0wN0LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapST2ptN0ptN0LPw;
		POSTagSet3Map<RET_TYPE> m_mapST2ptN0ptN0LPpt;

		// quar-gram
		// st2 + n0 + st2 right head + st2 right pred
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptST2RHptST2RPpt;
		// st2 + n0 + st2 left pred + st2 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptST2LPptST2LP2pt;
		// st2 + n0 + st2 right pred + st2 right pred 2
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptST2RPptST2RP2pt;
		// st2 + n0 + n0 left pred + n0 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapST2ptN0ptN0LPptN0LP2pt;

		// sst + n0 + sst left/right head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTwN0ptSSTLHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0wSSTLHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0ptSSTLHw;
		POSTagSet3Map<RET_TYPE> m_mapSSTptN0ptSSTLHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTwN0ptSSTLPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0wSSTLPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0ptSSTLPw;
		POSTagSet3Map<RET_TYPE> m_mapSSTptN0ptSSTLPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTwN0ptSSTRHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0wSSTRHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0ptSSTRHw;
		POSTagSet3Map<RET_TYPE> m_mapSSTptN0ptSSTRHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTwN0ptSSTRPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0wSSTRPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0ptSSTRPw;
		POSTagSet3Map<RET_TYPE> m_mapSSTptN0ptSSTRPpt;

		// sst + n0 + n0 left head/pred
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTwN0ptN0LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0wN0LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0ptN0LHw;
		POSTagSet3Map<RET_TYPE> m_mapSSTptN0ptN0LHpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTwN0ptN0LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0wN0LPpt;
		WordPOSTagPOSTagMap<RET_TYPE> m_mapSSTptN0ptN0LPw;
		POSTagSet3Map<RET_TYPE> m_mapSSTptN0ptN0LPpt;

		// quar-gram
		// sst + n0 + sst right head + sst right pred
		POSTagSet4Map<RET_TYPE> m_mapSSTptN0ptSSTRHptSSTRPpt;
		// sst + n0 + sst left pred + sst left pred 2
		POSTagSet4Map<RET_TYPE> m_mapSSTptN0ptSSTLPptSSTLP2pt;
		// sst + n0 + sst right pred + sst right pred 2
		POSTagSet4Map<RET_TYPE> m_mapSSTptN0ptSSTRPptSSTRP2pt;
		// sst + n0 + n0 left pred + n0 left pred 2
		POSTagSet4Map<RET_TYPE> m_mapSSTptN0ptN0LPptN0LP2pt;
