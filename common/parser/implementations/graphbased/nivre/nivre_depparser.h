...
namespace nivre {
	...
	void DepParser<RET_TYPE>::getOrUpdateFeatureScore(const StateItem & item, const AddScoreType & amount) {
		...
		cweight->m_mapSTptN0ptSTRHptSTRPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// st + n0 + st left pred + st left pred 2
		poses_feature = encodePOSTagSet4(st_postag, stlp_postag, stlp2_postag, n0_postag);
		cweight->m_mapSTptN0ptSTLPptSTLP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// st + n0 + st right pred + st right pred 2
		poses_feature = encodePOSTagSet4(st_postag, strp_postag, strp2_postag, n0_postag);
		cweight->m_mapSTptN0ptSTRPptSTRP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// st + n0 + n0 left pred + n0 left pred 2
		poses_feature = encodePOSTagSet4(st_postag, n0_postag, n0lp_postag, n0lp2_postag);
		cweight->m_mapSTptN0ptN0LPptN0LP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);

		// st2 + n0 + st2 left/right head/pred
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2lh_postag, n0_postag));
		cweight->m_mapST2wN0ptST2LHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2lh_postag));
		cweight->m_mapST2ptN0wST2LHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2lh_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		cweight->m_mapST2ptN0ptST2LHw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2lh_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2LHpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2lp_postag, n0_postag));
		cweight->m_mapST2wN0ptST2LPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2lp_postag));
		cweight->m_mapST2ptN0wST2LPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2lp_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		cweight->m_mapST2ptN0ptST2LPw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2lp_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2LPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2rh_postag, n0_postag));
		cweight->m_mapST2wN0ptST2RHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2rh_postag));
		cweight->m_mapST2ptN0wST2RHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2rh_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		cweight->m_mapST2ptN0ptST2RHw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2rh_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2RHpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(st2rp_postag, n0_postag));
		cweight->m_mapST2wN0ptST2RPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, st2rp_postag));
		cweight->m_mapST2ptN0wST2RPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2rp_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		cweight->m_mapST2ptN0ptST2RPw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, st2rp_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2RPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);

		// st2 + n0 + n0 left head/pred
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(n0_postag, n0lh_postag));
		cweight->m_mapST2wN0ptN0LHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, n0lh_postag));
		cweight->m_mapST2ptN0wN0LHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0lh_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		cweight->m_mapST2ptN0ptN0LHw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, n0_postag, n0lh_postag);
		cweight->m_mapST2ptN0ptN0LHpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(st2_word, ENCODE_POSTAG_SET_2(n0_postag, n0lp_postag));
		cweight->m_mapST2wN0ptN0LPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(st2_postag, n0lp_postag));
		cweight->m_mapST2ptN0wN0LPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0lp_word, ENCODE_POSTAG_SET_2(st2_postag, n0_postag));
		cweight->m_mapST2ptN0ptN0LPw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(st2_postag, n0_postag, n0lp_postag);
		cweight->m_mapST2ptN0ptN0LPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);

		// quar-gram
		// st2 + n0 + st2 right head + st2 right pred
		poses_feature = encodePOSTagSet4(st2_postag, st2rh_postag, st2rp_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2RHptST2RPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// st2 + n0 + st2 left pred + st2 left pred 2
		poses_feature = encodePOSTagSet4(st2_postag, st2lp_postag, st2lp2_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2LPptST2LP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// st2 + n0 + st2 right pred + st2 right pred 2
		poses_feature = encodePOSTagSet4(st2_postag, st2rp_postag, st2rp2_postag, n0_postag);
		cweight->m_mapST2ptN0ptST2RPptST2RP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// st2 + n0 + n0 left pred + n0 left pred 2
		poses_feature = encodePOSTagSet4(st2_postag, n0_postag, n0lp_postag, n0lp2_postag);
		cweight->m_mapST2ptN0ptN0LPptN0LP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);

		// sst + n0 + sst left/right head/pred
		bi_features.refer(sst_word, ENCODE_POSTAG_SET_2(sstlh_postag, n0_postag));
		cweight->m_mapSSTwN0ptSSTLHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(sst_postag, sstlh_postag));
		cweight->m_mapSSTptN0wSSTLHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sstlh_word, ENCODE_POSTAG_SET_2(sst_postag, n0_postag));
		cweight->m_mapSSTptN0ptSSTLHw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(sst_postag, sstlh_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTLHpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sst_word, ENCODE_POSTAG_SET_2(sstlp_postag, n0_postag));
		cweight->m_mapSSTwN0ptSSTLPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(sst_postag, sstlp_postag));
		cweight->m_mapSSTptN0wSSTLPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sstlp_word, ENCODE_POSTAG_SET_2(sst_postag, n0_postag));
		cweight->m_mapSSTptN0ptSSTLPw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(sst_postag, sstlp_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTLPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sst_word, ENCODE_POSTAG_SET_2(sstrh_postag, n0_postag));
		cweight->m_mapSSTwN0ptSSTRHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(sst_postag, sstrh_postag));
		cweight->m_mapSSTptN0wSSTRHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sstrh_word, ENCODE_POSTAG_SET_2(sst_postag, n0_postag));
		cweight->m_mapSSTptN0ptSSTRHw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(sst_postag, sstrh_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTRHpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sst_word, ENCODE_POSTAG_SET_2(sstrp_postag, n0_postag));
		cweight->m_mapSSTwN0ptSSTRPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(sst_postag, sstrp_postag));
		cweight->m_mapSSTptN0wSSTRPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sstrp_word, ENCODE_POSTAG_SET_2(sst_postag, n0_postag));
		cweight->m_mapSSTptN0ptSSTRPw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(sst_postag, sstrp_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTRPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);

		// sst + n0 + n0 left head/pred
		bi_features.refer(sst_word, ENCODE_POSTAG_SET_2(n0_postag, n0lh_postag));
		cweight->m_mapSSTwN0ptN0LHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(sst_postag, n0lh_postag));
		cweight->m_mapSSTptN0wN0LHpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0lh_word, ENCODE_POSTAG_SET_2(sst_postag, n0_postag));
		cweight->m_mapSSTptN0ptN0LHw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(sst_postag, n0_postag, n0lh_postag);
		cweight->m_mapSSTptN0ptN0LHpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(sst_word, ENCODE_POSTAG_SET_2(n0_postag, n0lp_postag));
		cweight->m_mapSSTwN0ptN0LPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0_word, ENCODE_POSTAG_SET_2(sst_postag, n0lp_postag));
		cweight->m_mapSSTptN0wN0LPpt.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		bi_features.refer(n0lp_word, ENCODE_POSTAG_SET_2(sst_postag, n0_postag));
		cweight->m_mapSSTptN0ptN0LPw.getOrUpdateScore(m_lPackedScore, bi_features, m_nScoreIndex, amount, m_nTrainingRound);
		poses_feature = ENCODE_POSTAG_SET_3(sst_postag, n0_postag, n0lp_postag);
		cweight->m_mapSSTptN0ptN0LPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);

		// quar-gram
		// sst + n0 + sst right head + sst right pred
		poses_feature = encodePOSTagSet4(sst_postag, sstrh_postag, sstrp_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTRHptSSTRPpt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// sst + n0 + sst left pred + sst left pred 2
		poses_feature = encodePOSTagSet4(sst_postag, sstlp_postag, sstlp2_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTLPptSSTLP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// sst + n0 + sst right pred + sst right pred 2
		poses_feature = encodePOSTagSet4(sst_postag, sstrp_postag, sstrp2_postag, n0_postag);
		cweight->m_mapSSTptN0ptSSTRPptSSTRP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
		// sst + n0 + n0 left pred + n0 left pred 2
		poses_feature = encodePOSTagSet4(sst_postag, n0_postag, n0lp_postag, n0lp2_postag);
		cweight->m_mapSSTptN0ptN0LPptN0LP2pt.getOrUpdateScore(m_lPackedScore, poses_feature, m_nScoreIndex, amount, m_nTrainingRound);
